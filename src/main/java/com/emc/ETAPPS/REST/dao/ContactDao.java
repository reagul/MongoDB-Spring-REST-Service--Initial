package com.emc.ETAPPS.REST.dao;
...
public class ContactDao {
    ...
    public void updatePhone(String id, String  newPhone){ 
        ...
        Query query = new Query(Criteria.where("id").is(id));
        mongoTemplate.updateFirst(query, Update.update("contactphone", newPhone), Contact.class);
    ...
    public void updateEmail(String id, String  newEmail){ 
        //logger.debug("updatePriority, id: {}, newPriority: {}", id, newPriority);
        Query query = new Query(Criteria.where("id").is(id));
        mongoTemplate.updateFirst(query, Update.update("email", newEmail), Contact.class);
